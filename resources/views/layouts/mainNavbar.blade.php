...
<body>
  <div id="app">
    <nav class="navbar navbar-expand-lg navbar-dark shadow-sm" style="background-color: #145DA0; height: 80px;">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="{{asset('assets/img/logovote.png')}}" width="50" height="50" class="d-inline-block align-top" alt="">
        </a>
        <a class="nav-link" href="https://smkn4pyk.sch.id/" style="color: aliceblue; font-weight:800; font-size:20px">E-Voting</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown"> 
              <a class="nav-link" href="https://linktr.ee/kukicha" class="text-white">Help</a>
            </li>
            <li class="nav-item dropdown"> 
